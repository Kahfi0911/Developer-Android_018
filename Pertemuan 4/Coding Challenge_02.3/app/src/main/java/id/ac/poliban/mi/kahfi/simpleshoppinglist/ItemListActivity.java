package id.ac.poliban.mi.kahfi.simpleshoppinglist;
...
import id.ac.poliban.mi.kahfi.simpleshoppinglist.databinding.ActivityItemListBinding;

public class ItemListActivity extends AppCompatActivity {
    public final static String ITEM_TAG = "id.ac.poliban.mi.kahfi.simpleshoppinglist.EXTRA.ITEM";
